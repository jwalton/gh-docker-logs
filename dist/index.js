...
const dest = core_1.default.getInput('dest') || undefined;
const images = core_1.default.getInput('images') || undefined;
const tail = core_1.default.getInput('tail');
const shell = core_1.default.getInput('shell');
